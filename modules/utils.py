...
def setup_logging(session_id):
    """
    Sets up logging with proper Unicode handling for Windows environments.
    
    Args:
        session_id: Unique identifier for the logging session
    ...
    # Create logger
    logger = logging.getLogger(f"assistant_{session_id}")
    logger.setLevel(logging.INFO)
    ...
    file_handler = logging.FileHandler(
        f"logs/assistant_{session_id}.log", 
        encoding='utf-8'
    )
